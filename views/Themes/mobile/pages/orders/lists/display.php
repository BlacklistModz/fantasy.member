...
<div class="row">
	<div class="lfloat mlm pal rfloat" role="search">
		<form class="form-search" action="" id="global-nav-search">
			...
			<input class="search-input inputtext" type="text" placeholder="ค้นหาเลขที่ใบบิล" name="key" autocomplete="off" value="<?=(!empty($_GET['key']) ? $_GET['key'] : '')?>">
...
<div class="wrapper web-lists-wrap active posts" data-plugins="datalistsbox" data-options="<?=$this->fn->stringify( array('url' => URL.'orders/'.(!empty($_GET['key']) ? '?key='.$_GET['key'] : '')) )?>">
