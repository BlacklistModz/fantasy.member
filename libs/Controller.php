...
class Controller {
    ...
    public function handleLogin(){
        ...
        $me = $this->model->query('customers')->get( Cookie::get( COOKIE_KEY_EMP ) );
            $dep = "Customer";
        ...
        if( !empty($_POST) && empty($error) ){
            ...
            if( $login_mode=='pin' && $this->format=='json' ){
                ...
                try {
                    ...
                    $id = $this->model->query('customers')->login($post['email'], $post['pass']);
                    ...
                    if( !empty($id) ){
                        ...
                        if( !$this->model->query('customers')->is_username($post['email']) ){
